...
document.addEventListener('click', function (e) {
  ...
  const filterBtn = document.getElementById("dropdownFilterButton");
  const filterMenu = document.getElementById("dropdownFilterMenu");
  ...
  // Tutup export dropdown
  const exportBtn = document.getElementById("dropdownExportButton");
  const exportMenu = document.getElementById("dropdownExportMenu");
