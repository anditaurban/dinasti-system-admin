...
async function handleDelete() {
  try {
    ...
    console.log("Result from deleteData:", result);

    // Periksa apakah result ada dan punya properti success
    ...
    console.error("Delete failed due to error:", error);
    showErrorDialog(`Failed to delete ${currentDataType}. Error occurred.`);
  }
}
